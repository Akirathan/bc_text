...
\def\Abstrakt{%
Cílem práce je vytvořit systém pro regulaci domácího vytápění.
Součástí celého systému je embedded zařízení z platformy STM32, které je umístěno u uživatele doma
a pravidelně měří a udržuje teplotu tak, jak ji uživatel přednastavil.
...
Součástí práce je návrh a implementace komunikace mezi a zařízením a webovým serverem,
v rámci které zařízení periodicky posílá na server naměřenou teplotu a synchronizuje
s ním nastavení.
}
\def\AbstraktEN{%
